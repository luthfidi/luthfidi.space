export const ABOUT = [
    "I'm Luthfi Hadi, a Computer Science graduate from BINUS University with hands-on experience in IT project management, Agile/Scrum methodologies, and end-to-end product delivery. I have a proven track record leading cross-functional teams and managing stakeholder communication across 11+ client projects.",
